...
export default function ProductList() {
  const products = [
    { name: "Apple MacBook Pro 17", SKU: 80, category: "Laptop", price: "$2999" },
    { name: "Microsoft Surface Pro", SKU: 20, category: "Laptop PC", price: "$1999" },
    { name: "Magic Mouse 2", SKU: 25, category: "Accessories", price: "$99" },
    { name: "Apple Watch", SKU: 50, category: "Accessories", price: "$179" },
    { name: "iPad", SKU: 40, category: "Tablet", price: "$699" },
    { name: "Apple iMac 27", SKU: 70, category: "PC Desktop", price: "$3999" },
  ];
  ...
  return (
    <section>
      <div className="w-full flex flex-col gap-5 relative overflow-x-auto sm:rounded-md items-stretch">
        ...
        <thead className="text-white bg-blue-500 font-medium rounded-t-md px-4 dark:bg-blue-400 dark:hover:bg-blue-500 py-2">
            <tr>
