'use client'
import CategoryForm from "@/components/Category/CategoryForm"; // Fixed typo in import path
    ...
    return (
        <section className="flex flex-col items-stretch gap-10 relative">
            <div className="flex flex-col md:flex-row md:justify-between items-center gap-5 w-[90%]">
                <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-400">Categories</h1>
                <button
            ...
            {showForm && (
                ...
                {/* <div className="fixed inset-10 z-[100000] top-[20%] flex h-full backdrop-blur-[2px] bg-black/10"> */}
